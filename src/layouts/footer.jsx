      ...
      <div class="flex flex-wrap -mx-4 text-center">
         <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="w-full mb-10">
               ...
               <p
                  class="flex items-center text-sm font-medium text-dark dark:text-white justify-center"
                  >
                  ...
                  <span className='text-center'>+212 6000 000 000</span>
               </p>
            </div>
         </div>
         ...
         <div class="relative mt-6 xl:w-[25vw] w-[100vw]">
  <input
    type="email"
    placeholder="Email address"
    autocomplete="email"
    aria-label="Email address"
    class="block  xl:w-full w-full  rounded-2xl border border-neutral-300 bg-transparent py-4 pl-6 pr-20 text-base/6 text-neutral-950 ring-4 ring-transparent transition placeholder:text-neutral-500 focus:border-neutral-950 focus:outline-none focus:ring-neutral-950/5"
  />
...
<button className=' bg-secondary-color font-thin text-lg text-white px-5 py-2 rounded-full xl:w-[15vw] '>Send Now</button></div>
         </div>
      </div>
   </div>
   <div>
         ...
         <svg
            ...
            <defs>
               <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                  >
                  <stop stop-color="#B31312" stop-opacity="0.31" />
                  <stop offset="1" stop-color="#C4C4C4" stop-opacity="0" />
               </linearGradient>
            </defs>
         </svg>
